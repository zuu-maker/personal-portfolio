          ...
          <div className="flex flex-wrap gap-4">
            {item.demo && (
              <a
                ...
                className="flex-1 py-4 px-6 bg-linear-to-r from-cyan-500 to-teal-500 rounded-xl text-white font-medium flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-cyan-500/25 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
            ...
            {item.code && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 py-4 px-6 bg-gray-800 hover:bg-gray-700 rounded-xl text-white font-medium flex items-center justify-center gap-2 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
